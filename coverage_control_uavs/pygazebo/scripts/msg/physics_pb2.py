...
_PHYSICS = _descriptor.Descriptor(
  ...
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor( # enum
      ...
      options=None),
    _descriptor.FieldDescriptor( # string
      ...
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor( # double
      ...
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor( #int32
    ...
    _descriptor.FieldDescriptor( #double
      ...
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor( #message : vecor3d
      ...
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor( #bool
