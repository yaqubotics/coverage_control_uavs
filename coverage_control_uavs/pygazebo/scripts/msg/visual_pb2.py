...
_VISUAL_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='1', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='2', index=1, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='3', index=2, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='4', index=3, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='5', index=4, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='6', index=5, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='7', index=6, number=7,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='8', index=7, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='9', index=8, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='10', index=9, number=10,
      options=None,
      type=None),
  ],
...
_VISUAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='gazebo.msgs.Visual.Type', index=15,
